...
class Product(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='价格', validators=[MinValueValidator(0)])
...
class Cart(models.Model):
    ...
    quantity = models.IntegerField(default=1, validators=[MinValueValidator(1)], verbose_name='数量')
